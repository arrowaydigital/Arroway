                ...
                {metrics.map((metric, index) => (
                  <FadeInSection key={metric.label} delay={index * 0.1}>
                    <motion.div
                      ...
                      className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-2xl border border-blue-100 hover:shadow-lg transition-shadow h-full"
                    >
                      <div className="w-12 h-12 bg-[#074edb] rounded-xl flex items-center justify-center mb-4">
