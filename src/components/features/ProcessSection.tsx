      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {steps.map((step, index) => (
              <FadeInSection key={step.id} delay={index * 0.1}>
                <div className={`flex flex-col ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-8`}>
                      ...
                      <ul className="space-y-2">
                        {step.details.map((detail, detailIndex) => (
                          <li key={detailIndex} className="flex items-center gap-3">
                            <div className="w-2 h-2 bg-[#074edb] rounded-full flex-shrink-0"></div>
                  ...
                  {/* Step number */}
                  <div className="relative lg:w-16 lg:h-16 flex items-center justify-center">
                    <div className="w-16 h-16 bg-[#074edb] rounded-full flex items-center justify-center text-white font-bold text-xl shadow-lg z-10">
                      {step.id}
                    </div>
                  </div>
        ...
        <FadeInSection delay={0.4}>
          <div className="text-center mt-16">
            <div className="bg-gradient-to-br from-[#074edb] to-[#063db3] rounded-2xl p-8 text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className="bg-white text-[#074edb] px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
