              ...
              <FadeInSection key={step.id} delay={index * 0.1}>
                <div className={`flex flex-col ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-8`}>
                  ...
                  <div className={`flex-1 ${index % 2 === 0 ? 'lg:text-right' : 'lg:text-left'} lg:w-1/2`}>
                    <div className="bg-white p-8 rounded border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                      {step.icon && (
                  ...
                  <div className="relative lg:w-16 lg:h-16 flex items-center justify-center">
                    <div className="w-16 h-16 bg-[#074edb] rounded flex items-center justify-center text-white font-bold text-xl shadow-lg z-10">
                      {step.id}
                    </div>
                  </div>
