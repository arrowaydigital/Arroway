          ...
          {caseStudies.map((study, index) => (
            <FadeInSection key={study.id} delay={index * 0.1}>
              <motion.div
                ...
                className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-lg transition-all h-full flex flex-col"
              >
                <div className="relative">
                  ...
                  />
                  <div className={`absolute top-4 right-4 bg-gradient-to-br ${study.color} rounded-full p-3 shadow-lg`}>
                ...
                <div className="p-6 flex-grow">
                  <div className="mb-4">
                    <span className="inline-block bg-blue-100 text-[#074edb] px-3 py-1 rounded-full text-sm font-medium mb-2">
                      {study.industry}
                    </span>
