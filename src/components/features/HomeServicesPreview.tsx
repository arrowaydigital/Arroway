          ...
          {services.map((service, index) => (
            <FadeInSection key={service.title} delay={index * 0.1}>
              <motion.div
                ...
                className="h-full bg-gradient-to-br from-gray-50 to-white p-6 rounded border border-gray-200 hover:border-[#074edb] hover:shadow-lg transition-all"
              >
                <div className={`w-12 h-12 bg-gradient-to-br ${service.color} rounded flex items-center justify-center mb-4`}>
